...
<html lang=''>
	...
	<body>
		...
		<center>
			<br>
			<form method="POST" action="atualizaReserva.php" enctype="multipart/form-data" name="addroom">
				<font size="5" color="06213f">Atualizar Reserva<br><br>
				<table border="0">
					<tr>
					...
					<tr>
						<td height="40" align="right">Data da entrada:</td>
