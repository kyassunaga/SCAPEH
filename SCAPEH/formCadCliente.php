...
<html lang=''>
	...
	<body>
		...
		<center>
			<br>
			<form method="POST" action="cadCliente.php" enctype="multipart/form-data" name="addroom">
				<font size="5" color="06213f">Cadastrar Cliente<br><br>
				<table border="0">
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="cli_rg" size="50" value="" maxlength="9"></td>
					</tr>
					<tr>
						<td align="right">CPF:</td>
						<td><input type="text" name="cli_cpf" size="50" value="" maxlength="11"></td>
					</tr>	
					<tr>
