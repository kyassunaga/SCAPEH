...
<html lang=''>
	...
	<body>
		...
		<center>
			<br>
			<form method="POST" action="cadTelefone.php">
				<font size="5" color="06213f">Cadastrar Telefone<br><br>
				<table border="0">
					<tr>
						<td align="right">Número:</td>
						<td> <input type="text" name="tel_numero" size="25" value="" maxlength="11"></td>
					</tr>
					<tr height=10></tr>
					<tr>
