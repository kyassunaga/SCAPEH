...
<html lang=''>
	...
	<body>
		...
		<center>
			<br>
			<form method="POST" action="consultaReserva.php">
				<font size="5" color="06213f">Consultar Reserva</font><br><br>
				<font size="4" color="06213f">Consultar pelo nome do Cliente
				<table border="0">
					<tr>
				...
				<br><center><input type=image src="img/lupa.png" width="60" height="40"></center><br><br>
			</form>
					
			<form method="POST" action="consultaReservaData.php">
				<font size="4" color="06213f">Consultar pela data
				<table border="0">
					<tr>
						<td align="right">Data da entrada:</td>
						<td><input type="text" name="res_data_entrada" size="30" value=""></td>
					</tr>
				</table>
				</font>
				<br><center><input type=image src="img/lupa.png" width="60" height="40"></center>
			</form>	
		</center>	
	</body>
<html>
