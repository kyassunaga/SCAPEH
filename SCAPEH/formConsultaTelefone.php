...
<html lang=''>
	<head>
		...
		<title>Consultar Telefone</title>
	</head>
	<body>
		...
		<center>
			<br>
			<form method="POST" action="consultaTelefoneNome.php">
				<font size="5" color="06213f">Consultar Telefone</font><br><br>
				<font size="4" color="06213f">Pelo nome do cliente
				<table border="0">
					<tr>
			...
			<form method="POST" action="consultaTelefone.php">
				<br><font size="4" color="06213f">Pelo número do telefone
				<table border="0">
					<tr>
						<td align="right" width="100">Número:</td>
						<td> <input type="text" name="tel_numero" size="25" value=""></td>
					</tr>
				</table>
				</font>
				<br><center><input type=image src="img/lupa.png" width=4% height=4%></center>
